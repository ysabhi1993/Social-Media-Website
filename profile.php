                ...
                <?php 
                    ...
                    if($userLoggedIn != $username){
                        ...
                        if($logged_in_user_obj->isFriend($username)){
                            ...
                            echo '<input type="submit" name="respond_request" class="warning" value="Respond"><br>';
                        }else if($logged_in_user_obj->didSendRequest($username)){
                            echo '<input type="submit" name="" class="default" value="Request Sent"><br>';
                        }
                        else
                            echo '<input type="submit" name="add_friend" class="succes  s" value="Add Friend"><br>';
                    }
                ...
                <div role='tabpanel' class='tab-pane fade' id='messages_div'>
                    ...
                    <div class="message_post">
                        <form action="" method="post">
                            ...
                            <input type='submit' name='post message' class='info' id='message_submit' value='Send'>
                        </form>
