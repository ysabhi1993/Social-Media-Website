...
class Message{
    ...
    public function getLatestMessage($userLoggedIn, $user2){
        $details_array = array();
        $query = mysqli_query($this->con, "select body, user_to, date from Messages where (user_to='$userLoggedIn' and user_from='$user2') or (user_from='$userLoggedIn' and user_to='$user2') order by id desc limit 1");
    ...
    public function getConvos(){
        ...
        foreach($convos as $username){
            ...
            $return_string .= "<a href='messages.php?u=$username'> <div class='user_found_messages'> 
                                ...
                                <p id='grey' style='margin: 0px;'>". $latest_message_details[0].$split."</p></div>
                                </a>";
        }
